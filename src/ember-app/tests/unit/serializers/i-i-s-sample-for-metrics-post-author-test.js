...
moduleForModel('i-i-s-sample-for-metrics-post-author', 'Unit | Serializer | i-i-s-sample-for-metrics-post-author', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-sample-for-metrics-post-author',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
