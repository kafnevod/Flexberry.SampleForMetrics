...
moduleForAcceptance('[AGAT] Acceptance | i i s sample for metrics blog post l');

test('testing i-i-s-sample-for-metrics-blog-post-l', function(assert) {
  visit('/i-i-s-sample-for-metrics-blog-post-l');
