...
moduleForAcceptance('[AGAT] Acceptance | i i s sample for metrics tag type l');

test('testing i-i-s-sample-for-metrics-tag-type-l', function(assert) {
  visit('/i-i-s-sample-for-metrics-tag-type-l');
