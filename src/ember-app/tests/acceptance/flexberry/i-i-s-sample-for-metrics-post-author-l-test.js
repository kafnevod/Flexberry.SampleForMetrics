...
moduleForAcceptance('[AGAT] Acceptance | i i s sample for metrics post author l');

test('testing i-i-s-sample-for-metrics-post-author-l', function(assert) {
  visit('/i-i-s-sample-for-metrics-post-author-l');
